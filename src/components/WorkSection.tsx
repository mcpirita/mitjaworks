        ...
        {work.map((item) => {
          ...
          return (
            <article key={item.slug}>
              <Shell>
                <header className="reveal flex flex-col gap-3 border-b border-line pb-5 md:flex-row md:items-baseline md:justify-between">
                ...
                <div className="reveal-frame mt-8">
                  <PhotoPlate
                    src={lead.src}
                    ratio={lead.ratio}
                  ...
                  {rest.map((frame, i) => {
                    ...
                    return (
                      <PhotoPlate
                        ...
                        className={
                          full ? "reveal-frame sm:col-span-2" : "reveal-frame"
                        }
                        sizes={
                          full
